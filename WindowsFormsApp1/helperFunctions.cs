...
namespace HelperFunctions
{
    ...
    public static class HelperFunctions
    {
        ...
        //Helper Functions
        public static string multilineToSinglelineFunc(string inputString)
        {
            /* Purpose:
        ...
        public static string openFileFunc(string pathToFile)
        {
            /* Purpose:
        ...
        public static string findAndReplaceFunc(string data, string toSearch, string replaceStr)
        {
            /* Purpose:
        ...
        public static void callAllFileFuncs(string pathToFile, string toSearch, string replaceStr)
        {
            /* Purpose:
